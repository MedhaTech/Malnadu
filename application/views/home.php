    ...
    <div class="rev_slider_wrapper">
      <div class="rev_slider" data-version="5.0">
        <ul>
          ...
          <!-- SLIDE 3 -->
          <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="<?php echo base_url(); ?>assets/images/slider3.png" data-rotate="0" data-saveperformance="off" data-title="Slide 3" data-description="">
            <!-- MAIN IMAGE -->
            ...
            <!-- SLIDE 3 -->
            <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="<?php echo base_url(); ?>assets/images/RatingCertificate.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 3" data-description="">
            <!-- MAIN IMAGE -->
            <img src="<?php echo base_url(); ?>assets/images/RatingCertificate.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-bgparallax="10" data-no-retina>
            <!-- LAYERS -->
        ...
        <div class="row equal-height-inner home-boxes">
          ...
          <div class="col-sm-12 col-md-3 pl-0 pl-sm-15 pr-0 pr-sm-15 sm-height-auto mt-sm-0 wow fadeInLeft animation-delay2">
            <div class="sm-height-auto bg-theme-color-2">
              <div class="p-30">
                <h3 class="text-uppercase text-white mt-0">Awards, Medals and Patents</h3>
                ...
                ?>
                      ...
                      <article class="post media-post clearfix pb-0 mb-10">
                        <div class="post-right">
                          <h5 class="mt-0 mb-5"><?php echo anchor('home/news/' . $latestNews1->news_slug, $latestNews1->news_title, 'class="title"'); ?></h5>
      ...
      <div class="section-content">
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-12">
            <iframe src="https://experience.vr360ty.com/mce/" width="100%" height="400" frameborder="0" style="border:0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
          </div>
        </div>
      </div>
    </div>
